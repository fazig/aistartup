...
export const postFifaAi2 : BlogPost = {
  ...
  content: `![Image](/fifa_ai_prediction.png)

## Welcome to the Future of Soccer!

We all love guessing which team will win. But what if a super-smart robot could guess the winner before the game even starts?
