  ...
  const categories = [
    {
      ...
      tools: [
        ...
        { name: "Disclaimer Generator", path: "#", live: false },
    ...
    },
    {
      ...
      tools: [
        ...
        { name: "ICO to PNG", path: "#", live: false },
        { name: "ICO Converter", path: "#", live: false },
        { name: "Flip Image", path: "#", live: false },
        { name: "Rotate Image", path: "#", live: false },
        { name: "Image Enlarger", path: "#", live: false },
        { name: "Image Cropper", path: "#", live: false },
        { name: "Image Resizer", path: "#", live: false },
        { name: "Image Converter", path: "#", live: false },
        { name: "JPG to PNG", path: "#", live: false },
        { name: "PNG to JPG", path: "#", live: false },
        { name: "WebP to JPG", path: "#", live: false },
        { name: "PNG to WebP", path: "#", live: false },
        { name: "JPG to WebP", path: "#", live: false },
      ]
    },
    {
      id: "calculators",
      ...
      tools: [
        ...
        { name: "Average Calculator", path: "#", live: false },
        { name: "Confidence Interval Calculator", path: "#", live: false },
        { name: "Margin Calculator", path: "#", live: false },
        { name: "Probability Calculator", path: "#", live: false },
        { name: "CPM Calculator", path: "#", live: false },
        { name: "GST Calculator", path: "#", live: false },
        { name: "Days Calculator", path: "#", live: false },
        { name: "Hours Calculator", path: "#", live: false },
        { name: "Stripe Fee Calculator", path: "#", live: false },
        { name: "Calorie Calculator", path: "#", live: false },
        { name: "TDEE Calculator", path: "#", live: false },
      ]
    },
    {
      id: "unit-converters",
      ...
      bg: "#ecfeff",
      tools: [
        { name: "Length Converter", path: "#", live: false },
        { name: "Area Converter", path: "#", live: false },
        { name: "Weight Converter", path: "#", live: false },
        { name: "Volume Converter", path: "#", live: false },
        { name: "Temperature Converter", path: "#", live: false },
        { name: "Time Converter", path: "#", live: false },
        { name: "Speed Converter", path: "#", live: false },
        { name: "Digital Storage Converter", path: "#", live: false },
        { name: "Pressure Converter", path: "#", live: false },
        { name: "Power Converter", path: "#", live: false },
        { name: "Voltage Converter", path: "#", live: false },
        { name: "Current Converter", path: "#", live: false },
        { name: "Pace Converter", path: "#", live: false },
      ]
    },
    {
      ...
      bg: "#fdf2f8",
      tools: [
        { name: "Text to Binary", path: "#", live: false },
        { name: "Binary to Text", path: "#", live: false },
        { name: "Decimal to Binary", path: "#", live: false },
        { name: "Binary to Decimal", path: "#", live: false },
        { name: "Text to ASCII", path: "#", live: false },
        { name: "ASCII to Text", path: "#", live: false },
        { name: "HEX to Decimal", path: "#", live: false },
        { name: "Decimal to HEX", path: "#", live: false },
        { name: "Octal to Binary", path: "#", live: false },
        { name: "Binary to Octal", path: "#", live: false },
        { name: "Text to HEX", path: "#", live: false },
        { name: "HEX to Text", path: "#", live: false },
        { name: "Text to Decimal", path: "#", live: false },
        { name: "Decimal to Text", path: "#", live: false },
      ]
    },
    {
      ...
      tools: [
        ...
        { name: "HTML Minifier", path: "#", live: false },
        ...
        { name: "QR Code Decoder", path: "#", live: false },
        { name: "URL Parser", path: "#", live: false },
      ]
    },
    {
      id: "developer-tools",
