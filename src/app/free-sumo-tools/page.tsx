  ...
  const categories = [
    ...
    },
    {
      ...
      tools: [
        ...
        { name: "HTML Beautifier", path: "/tools/html-beautifier", live: true },
        { name: "HTML Minifier", path: "/tools/html-minifier", live: true },
        { name: "CSS Beautifier", path: "/tools/css-beautifier", live: true },
        { name: "CSS Minifier", path: "/tools/css-minifier", live: true },
        { name: "JavaScript Beautifier", path: "/tools/javascript-beautifier", live: true },
        { name: "JavaScript Minifier", path: "/tools/javascript-minifier", live: true },
